...
declare namespace Spotify {
    ...
    declare type ScopeDefinition = string | Scope | Scope[];
    ...
    declare interface RecentlyPlayedParameterObject {
        limit?: number;
        after?: number;
        before?: number;
    }

    declare interface TransferPlaybackParameterObject {
        play?: boolean;
    }

    declare interface QueueParameterObject {
        device_id?: string;
    }

    declare interface TrackRelinkingParameterObject {
        market?: string;
    }

    declare interface DeviceSpecificParameterObject {
        device_id?: string;
        context_uri?: string;
        position_ms?: number;
        uris?: string[];
    ...
    declare interface PlayParameterObject {
        device_id?: string;
        context_uri?: string;
        uris?: string[];
        offset?: {
     ...
     */
    declare interface SingleAlbumResponse extends AlbumObjectFull {}
     ...
     */
    declare interface AlbumTracksResponse extends PagingObject<TrackObjectSimplified> {}
     ...
     */
    declare interface SingleArtistResponse extends ArtistObjectFull {}
     ...
     */
    declare interface ArtistsAlbumsResponse extends PagingObject<AlbumObjectSimplified> {}
     ...
     */
    declare interface SingleShowResponse extends ShowObjectFull {}
     ...
     */
    declare interface MultipleShowsResponse {
     ...
     */
    declare interface ShowEpisodesResponse extends PagingObject<EpisodeObjectSimplified> {}
     ...
     */
    declare interface SingleEpisodeResponse extends EpisodeObjectFull {}
     ...
     */
    declare interface MultipleEpisodesResponse {
     ...
     */
    declare interface AudioAnalysisResponse extends Object {}
     ...
     */
    declare interface AudioFeaturesResponse extends AudioFeaturesObject {}
     ...
     */
    declare interface SingleCategoryResponse extends CategoryObject {}
     ...
     */
    declare interface CategoryPlaylistsResponse {
        playlists: PagingObject<PlaylistObjectSimplified>;
    }
     ...
     */
    declare interface CurrentUsersProfileResponse extends UserObjectPrivate {}
     ...
     */
    declare interface FollowArtistsOrUsersResponse extends VoidResponse {}
     ...
     */
    declare interface UnfollowArtistsOrUsersResponse extends VoidResponse {}
     ...
     */
    declare interface UserFollowsUsersOrArtistsResponse extends Array<boolean> {}
     ...
     */
    declare interface FollowPlaylistResponse extends VoidResponse {}
     ...
     */
    declare interface UnfollowPlaylistResponse extends VoidResponse {}
     ...
     */
    declare interface SaveTracksForUserResponse extends VoidResponse {}
     ...
     */
    declare interface UsersSavedTracksResponse extends PagingObject<SavedTrackObject> {}
     ...
     */
    declare interface RemoveUsersSavedTracksResponse extends VoidResponse {}
     ...
     */
    declare interface CheckUsersSavedTracksResponse extends Array<boolean> {}
     ...
     */
    declare interface SaveAlbumsForUserResponse extends VoidResponse {}
     ...
     */
    declare interface UsersSavedAlbumsResponse extends PagingObject<SavedAlbumObject> {}
     ...
     */
    declare interface RemoveAlbumsForUserResponse extends VoidResponse {}
     ...
     */
    declare interface CheckUserSavedAlbumsResponse extends Array<boolean> {}
     ...
     */
    declare interface UsersTopArtistsResponse extends PagingObject<ArtistObjectFull> {}
     ...
     * https://developer.spotify.com/web-api/get-users-top-artists-and-tracks/
     */
    declare interface UsersTopTracksResponse extends PagingObject<TrackObjectFull> {}
     ...
     * https://developer.spotify.com/web-api/get-users-top-artists-and-tracks/
     */
    declare interface UsersRecentlyPlayedTracksResponse extends CursorBasedPagingObject<PlayHistoryObject> {}
     ...
     */
    declare interface RecommendationsFromSeedsResponse extends RecommendationsObject {}
     ...
     * https://developer.spotify.com/web-api/search-item/
     */
    declare interface ShowSearchResponse {
     ...
     * https://developer.spotify.com/web-api/search-item/
     */
    declare interface EpisodeSearchResponse {
     ...
     */
    declare interface SingleTrackResponse extends TrackObjectFull {}
     ...
     */
    declare interface UserProfileResponse extends UserObjectPublic {}
     ...
     */
    declare interface ListOfUsersPlaylistsResponse extends PagingObject<PlaylistObjectSimplified> {}
     ...
     * https://developer.spotify.com/web-api/get-list-users-playlists/
     */
    declare interface ListOfCurrentUsersPlaylistsResponse extends PagingObject<PlaylistObjectSimplified> {}
     ...
     */
    declare interface SinglePlaylistResponse extends PlaylistObjectFull {}
     ...
     */
    declare interface PlaylistTrackResponse extends PagingObject<PlaylistTrackObject> {}
     ...
     */
    declare interface CreatePlaylistResponse extends PlaylistObjectFull {}
     ...
     */
    declare interface ChangePlaylistDetailsResponse extends VoidResponse {}
     ...
     */
    declare interface AddTracksToPlaylistResponse extends PlaylistSnapshotResponse {}
     ...
     */
    declare interface RemoveTracksFromPlaylistResponse extends PlaylistSnapshotResponse {}
     ...
     */
    declare interface ReorderPlaylistTracksResponse extends PlaylistSnapshotResponse {}
     ...
     */
    declare interface ReplacePlaylistTracksResponse extends VoidResponse {}
     ...
     */
    declare interface UploadCustomPlaylistCoverImageResponse extends VoidResponse {}
     ...
     */
    declare interface PlaylistCoverImageResponse extends Array<ImageObject> {}
     ...
     */
    declare interface UsersFollowPlaylistResponse extends Array<boolean> {}

    declare interface UserDevicesResponse {
        devices: UserDevice[];
    }

    declare interface CurrentPlaybackResponse extends CurrentlyPlayingObject, PlaybackObject {}

    declare interface CurrentlyPlayingResponse extends CurrentlyPlayingObject {}
     ...
     */
    declare interface ListOfUsersShowsResponse extends PagingObject<SavedShowObject> {}
     ...
     */
    declare interface SaveShowsForUserResponse extends VoidResponse {}
     ...
     */
    declare interface RemoveUsersSavedShowsResponse extends VoidResponse {}
     ...
     */
    declare interface CheckUsersSavedShowsResponse extends Array<boolean> {}
     ...
     */
    declare interface AlbumObjectFull extends AlbumObjectSimplified {
     ...
     */
    declare interface ArtistObjectFull extends ArtistObjectSimplified {
     ...
     * [](https://developer.spotify.com/web-api/object-model/)
     */
    declare interface PlaylistObjectFull extends PlaylistBaseObject {
        followers: FollowersObject;
     ...
     * [](https://developer.spotify.com/web-api/object-model/)
     */
    declare interface PlaylistObjectSimplified extends PlaylistBaseObject {
        tracks: {
            href: string;
            total: number;
        };
     ...
     */
    declare interface TrackObjectFull extends TrackObjectSimplified {
     ...
     * [](https://developer.spotify.com/web-api/object-model/#track-object-simplified)
     */
    declare interface UserObjectPrivate extends UserObjectPublic {
        birthdate: string;
        country: string;
        email: string;
        product: string;
    ...
    declare interface PlaybackObject {
     ...
     */
    declare interface ShowObjectFull extends ShowObjectSimplified {
     ...
     */
    declare interface ShowObjectSimplified {
        available_markets?: string[];
        copyrights: CopyrightObject[];
        description: string;
        explicit: boolean;
     ...
     */
    declare interface EpisodeObjectFull extends EpisodeObjectSimplified {
        show: ShowObjectSimplified;
    }
     ...
     */
    declare interface EpisodeObjectSimplified {
    ...
    declare type ContextObjectType = 'artist' | 'playlist' | 'album';
    declare type PlaybackRepeatState = 'off' | 'track' | 'context';

    declare type ReAuthenticationResponse = Omit<AuthenticationResponse, 'refresh_token'>;
