...
export type ScopeDefinition = string | Scope | Scope[];
 ...
 */
export interface ShowEpisodesResponse extends PagingObject<EpisodeObjectSimplified> {}
...
export type ReAuthenticationResponse = Omit<AuthenticationResponse, 'refresh_token'>;
